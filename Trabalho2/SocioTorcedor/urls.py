...
urlpatterns = [
    ...
    path('planos/meus_planos/', views.PlanoAdquiridoView.as_view(), name='render_my_plans'),
    path('planos/meus_planos/delete/<int:pk>/', views.PlanoAdquiridoDeleteView.as_view(), name='delete_my_plans'),
